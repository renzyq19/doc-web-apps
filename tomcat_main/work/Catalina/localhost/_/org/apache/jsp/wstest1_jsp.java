 ...
 * Generated at: 2013-06-19 17:11:55 UTC
...
public final class wstest1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("    <head>\n");
      out.write("        <title>Gunship Galaxy</title>\n");
      out.write("        <link rel='stylesheet' type='text/css' href='styles/main.css'>\n");
      out.write("        <link rel='stylesheet' type='text/css' href='styles/wstest.css'>\n");
      out.write("    </head>\n");
      out.write("\n");
      out.write("    <body>\n");
      out.write("        <div id=\"chat\"> \n");
      out.write("            <div id='display'>\n");
      out.write("                <textarea readonly class='display' id=\"monitor\"></textarea>\n");
      out.write("                <div readonly class='display' id='connected'></div>\n");
      out.write("            </div>\n");
      out.write("            <div id=\"response\">\n");
      out.write("                <form onsubmit='return sendResponse();'>\n");
      out.write("                    <p><input type='text' autocomplete='off' id='message' placeholder='Say something!'></p>\n");
      out.write("                </form>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("        <div id=\"container\"></div>\n");
      out.write("        <script src=\"game/packages/jquery.js\"></script>\n");
      out.write("        <script src=\"game/packages/kineticjs.js\"></script>\n");
      out.write("        <script src=\"game/packages/createjs.js\"></script>\n");
      out.write("        <script src=\"game/js/bonusrandomise.js\"></script>\n");
      out.write("        <script src=\"game/js/config.js\"></script>\n");
      out.write("        <script src=\"game/js/gunship.js\"></script>\n");
      out.write("        <script src=\"game/js/controller.js\"></script>\n");
      out.write("        <script src=\"game/js/collision.js\"></script>\n");
      out.write("        <script src=\"game/js/bullet.js\"></script>\n");
      out.write("        <script src=\"game/js/gunshipgalaxy.js\"></script>\n");
      out.write("        <script src=\"game/js/sound.js\"></script>\n");
      out.write("        <script src=\"game/js/menu.js\"></script>\n");
      out.write("        <script src=\"game/js/ai.js\"></script>\n");
      out.write("        <script src=\"game/js/endmenu.js\"></script>\n");
      out.write("        <script>\n");
      ...
      out.write("                this.send(\"HELLO\\n\" + ");
      out.print("\""+request.getParameter("real-data")+"\"");
      out.write(");\n");
      out.write("            }\n");
      ...
      out.write("                }\n");
      out.write("            }\n");
      out.write("            connection.onClose = function() {\n");
      out.write("                document.getElementById(\"connected\").innerHTML = \"\";\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            function writeToMonitor(message) {\n");
      out.write("                document.getElementById(\"monitor\").innerHTML+=message+\"\\n\";\n");
      out.write("            }\n");
      out.write("\n");
      ...
      out.write("                        case \"#\": addPlayer(name,index);break;\n");
      out.write("                        case \"+\":\n");
      out.write("                          if(isServerSideName(name)) {\n");
      out.write("                            writeToMonitor(\"You have connected.\");\n");
      out.write("                          } else {\n");
      out.write("                            addPlayer(name,index);\n");
      out.write("                          }\n");
      out.write("                          break;\n");
      out.write("                        case \"-\":\n");
      out.write("                          removePlayer(name,index);\n");
      out.write("                        break;\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            var currentPlayers = document.getElementById(\"connected\");\n");
      out.write("\n");
      out.write("            function addPlayer(name, index) {\n");
      out.write("              var p = document.createElement(\"p\");\n");
      out.write("              p.id = \"_p\"+index;\n");
      out.write("              p.innerHTML = name;\n");
      out.write("              currentPlayers.appendChild(p);\n");
      out.write("              writeToMonitor(name+\" has connected.\");\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            function removePlayer(name, index) {\n");
      out.write("              var p =document.getElementById(\"_p\"+index);\n");
      out.write("              p.parentNode.removeChild(p);\n");
      out.write("              writeToMonitor(name+\" has disconnected.\");\n");
      out.write("            }\n");
      out.write("\n");
      ...
      out.write("                var responseBox = document.getElementById(\"message\");\n");
      out.write("                if(responseBox.value != '') connection.send(\"MSG\\n\"+serverSideName+\"\\n\"+responseBox.value);\n");
      out.write("                responseBox.value = \"\";\n");
      out.write("                responseBox.focus();\n");
